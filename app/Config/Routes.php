...
$routes->add('/fMasyarakat', 'MasyarakatController::create');
$routes->get('masyarakat/edit/(:segment)', 'MasyarakatController::edit/$1');
...
$routes->add('pengaduan/edit/(:segment)', 'PengaduanController::tanggapi/$1');
