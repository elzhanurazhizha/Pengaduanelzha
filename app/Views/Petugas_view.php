...
<div class="container-fluid">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/petugas/delete<?= $row['id_petugas'] ?>" onclick="return confirm('Yakin ingin menghapus data ?')" class="btn btn-danger">hapus</a>
                                </td>
                            </tr>
                        <?php
                        }
    ...
    <div class="modal fade" id="fPetugas" tabindex="-1" aria-labelledby="exampleModelLabel" aria-hidden="true">
